...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.Time = "Waiting...";
        __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["a" /* Observable */].interval(500)
            .subscribe(function (x) {
            _this.socketService.GetTime()
                .subscribe(function (s) { return _this.Time = s; });
        });
    };
...
var SocketService = (function () {
    ...
    SocketService.prototype.GetTime = function () {
        return this.client.get('/api/time');
    };
